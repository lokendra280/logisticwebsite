...
<body>
                                ...
                                <div class="col-lg-4 padding-tb-15px">
                                    <div class="contact-info opacity-9">
                                        ...
                                        <div class="text">
                                            ...
                                            <span class="font-weight-500 text-uppercase text-main-color">Np - Kathmandu</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- // contact info -->
                                ...
                                <div class="col-lg-4 padding-tb-15px">
                                    <div class="contact-info opacity-9">
                                        ...
                                        <div class="text">
                                            ...
                                            <span class="font-weight-500 text-uppercase text-main-color">kathcity@gmail.com</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- // contact info -->
                                ...
                                <div class="col-lg-4 padding-tb-15px">
                                    <div class="contact-info opacity-9">
                                        ...
                                        <div class="text">
                                            ...
                                            <span class="font-weight-500 text-uppercase text-main-color">081-560920</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- // contact info -->
                    ...
                    <div class="row">
                        <div class="col-lg-10 position-inherit">
                            ...
                            <div class="d-none d-xl-block pull-right model-link margin-top-5px">
                                {{-- <a id="cart-link" class="model-link margin-right-0px text-white opacity-hover-8" href="#">
                            ...
                            <div class="d-none d-xl-block search-link pull-right model-link margin-top-5px">
                                ...
                                <a id="search-header" class="model-link margin-right-0px text-white opacity-hover-8" href="login">
							<i class="fa fa-sign-in"></i>
						</a>
                            </div>
                            <div class="d-none d-xl-block search-link pull-right model-link margin-top-5px">
                                <a id="search-header" class="model-link margin-right-0px text-white opacity-hover-8" href="register">
                        ...
                        <div class="col-lg-2 col-md-12  d-none d-lg-block">
                            <a data-toggle="modal" data-target=".bd-example-modal-lg" href="#" class="btn btn-sm border-radius-30 margin-tb-12px text-white  background-dark  box-shadow float-right padding-lr-20px margin-left-30px d-block">
                          <i class="fa fa-envelope-o"></i>  Send Feedback
                        </a>
                        </div>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-7">
                        <div class="padding-30px">
                            <h3 class="padding-bottom-15px">Feedback Form</h3>
                            <form>
                                <div class="form-row">
    ...
    <div id="rev_slider_7_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="logistics-5" data-source="gallery" style="margin:0px auto;background:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="text-center sm-mb-45px">
                        <img src="assets/img/about-4.jpg" alt="" class="border-radius-500">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="service-icon-box">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="testimonials layout-1">
                        ...
                        <div class="meta">
                            ...
                            <div class="name">Deepak Bhandari</div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="contact-info-map">
                            <div class="margin-bottom-30px">
                                ...
                                <div class="contact-info opacity-9">
                                    ...
                                    <div class="text">
                                        <span class="title-in">Location :</span> <br>
                                        <span class="font-weight-500 text-uppercase">Np-kathmandu </span>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="call_center margin-top-30px">
                                ...
                                <div class="contact-info opacity-9">
                                    ...
                                    <div class="text">
                                        <span class="title-in">Call Us :</span><br>
                                        <span class="font-weight-500 text-uppercase">081-5609020</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="about-us sm-mb-45px">
                        <div class="logo-footer margin-bottom-35px">
                            <a href="#"><img src="assets/img/logo-dark-3.png" alt=""></a>
                        </div>
